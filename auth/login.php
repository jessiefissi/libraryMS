<?php
// PHP Login Logic - must be at the very top before any output
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $baseUrl = (count($projectFolder) > 1) ? ($protocol . $host . '/' . $projectFolder[0]) : ($protocol . $host);
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
                ...
                <form class="space-y-6" id="loginForm" method="POST">
                    ...
                    <div>
                        <button type="submit"
                            ...
                            <span id="loginBtnLoading" class="flex items-center hidden">
        ...
        <script>
            ...
            // Handle form submission with normal JS
