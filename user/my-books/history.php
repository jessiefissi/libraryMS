...
$stmt = $db->prepare("SELECT ib.*, b.title, b.author, b.isbn, b.category_id, c.name as category, ib.return_date FROM issued_books ib JOIN books b ON ib.book_id = b.id LEFT JOIN categories c ON b.category_id = c.id WHERE ib.user_id = ? AND ib.status = 'returned' ORDER BY ib.issue_date DESC");
...
<head>
    ...
    <title>My Borrowing History - Library</title>
...
<div class="flex">
    ...
    <main class="flex-1 p-6">
        <h1 class="text-3xl font-bold mb-4">My Borrowing History</h1>
        <div class="bg-white rounded-lg shadow p-6">
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <?php endforeach; ?>
                    <?php if (empty($books)): ?>
                        <tr><td colspan="6" class="text-center text-gray-500 py-4">No borrowing history found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
